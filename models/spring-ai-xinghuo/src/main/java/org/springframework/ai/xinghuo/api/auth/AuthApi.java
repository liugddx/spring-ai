...
public abstract class AuthApi {
	 ...
	 */
	public static String generateAuthUrl(String host, String path, String httpMethod, String apiKey, String apiSecret)
			throws Exception {
	 ...
	 */
	private static String generateAuthorization(String host, String date, String httpMethod, String path, String apiKey,
		...
		// 2.5 Encode the 'authorization_origin' string using Base64 to get the final
		// 'authorization'
	...
	private static String buildUrl(String host, String path, String authorization, String date) {
		...
		return baseUrl + "?" + "authorization=" + URLEncoder.encode(authorization, StandardCharsets.UTF_8) + "&date="
				+ URLEncoder.encode(date, StandardCharsets.UTF_8) + "&host="
