 ...
 * @since 1.0
 */
public class XinHuoAuthenticator {
	...
	public XinHuoAuthenticator(String authUrl, String apiKey, String secretKey) {
		this.apiKey = apiKey;
	...
	public XinHuoAccessToken requestToken() {
		...
		return new XinHuoAccessToken(tokenResponse);
	}
	...
	public static class Builder {
		...
		public XinHuoAuthenticator build() {
			return new XinHuoAuthenticator(DEFAULT_AUTH_URL, this.apiKey, this.secretKey);
		}
